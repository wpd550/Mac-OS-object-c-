...
- (void)setupDefaults {
    self.needRemoveGroupIndexes = YES;
}
...
- (NSIndexSet *)tableView:(NSTableView *)tableView selectionIndexesForProposedSelection:(NSIndexSet *)proposedSelectionIndexes {
    ...
    if (self.needRemoveGroupIndexes) { // 组行不能选中
        NSMutableIndexSet *noGroupIndexes = proposedSelectionIndexes.mutableCopy;
        [noGroupIndexes removeIndexes:[self.baseViewModel groupModelIndexes]];
        return noGroupIndexes;
    }
